...
def bar6() ->Liquid:
    c = (
        Liquid()
            ...
            .set_global_opts(title_opts=opts.TitleOpts(title="今日学习专注度"))
    )
    return c
...
def bar7() ->Pie:
    c = (
        ...
        .add(
            ...
            .set_global_opts(
            title_opts=opts.TitleOpts(title="学生学习疲劳分布图"),
...
def bar1() ->Bar:
    bar = (
        ...
        .add_yaxis("学生疲劳程度", [10, 20, 30, 60, 50, 80])
        .set_global_opts(
            xaxis_opts=opts.AxisOpts(axislabel_opts=opts.LabelOpts(rotate=-15)),
            title_opts=opts.TitleOpts(title="学生学习疲劳程度实时变化图", pos_left=20),
...
def bar2() ->Bar:
    bar = (
        ...
        .add_yaxis("学生眨眼频率", [0.89, 0.56, 1.23, 0.56, 1.43, 0.45])
        .set_global_opts(
            xaxis_opts=opts.AxisOpts(axislabel_opts=opts.LabelOpts(rotate=-15)),
            title_opts=opts.TitleOpts(title="学生学习眨眼频率实时变化图", pos_left=20),
            datazoom_opts=opts.DataZoomOpts(is_show=True, is_realtime=True),
            toolbox_opts=opts.ToolboxOpts(is_show=True),
            legend_opts=opts.LegendOpts(pos_right='20%'),
        )
...
def bar3() ->Bar:
    bar = (
        ...
        .add_yaxis("学生打哈欠频率", [0.45, 0.73, 0.28, 0.36, 0.43, 0.12])
        .set_global_opts(
            xaxis_opts=opts.AxisOpts(axislabel_opts=opts.LabelOpts(rotate=-15)),
            title_opts=opts.TitleOpts(title="学生学习打哈欠频率实时变化图", pos_left=20),
            datazoom_opts=opts.DataZoomOpts(is_show=True, is_realtime=True),
            toolbox_opts=opts.ToolboxOpts(is_show=True),
            legend_opts=opts.LegendOpts(pos_right='20%'),
        )
...
def bar4() ->Bar:
    bar = (
        ...
        .add_yaxis("学生瞌睡点头频率", [0.45, 0.73, 0.28, 0.36, 0.43, 0.12])
        .set_global_opts(
            xaxis_opts=opts.AxisOpts(axislabel_opts=opts.LabelOpts(rotate=-15)),
            title_opts=opts.TitleOpts(title="学生学习瞌睡点头频率实时变化图", pos_left=20),
            datazoom_opts=opts.DataZoomOpts(is_show=True, is_realtime=True),
            toolbox_opts=opts.ToolboxOpts(is_show=True),
            legend_opts=opts.LegendOpts(pos_right='20%'),
        )
...
def page_draggable_layout():
    ...
    page.render("study_fatigue_detect.html")
